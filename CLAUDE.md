# azurelocal-app-services — Claude Code Context
...
- `azurelocal-app-services-engineer` (model: sonnet) — Expert in `azurelocal-app-services`: deep knowledge of this repo's structure, conventions, and development workflow.
